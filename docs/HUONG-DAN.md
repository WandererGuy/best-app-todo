...
**Tổng quan** — hàng trên toàn là chỉ số của hôm nay: việc đến hạn hôm nay, việc trễ hạn, việc xong hôm nay, phiên tập trung so với mục tiêu ngày, thói quen đã tick, chuỗi ngày viết nhật ký. Bấm vào ô là sang thẳng mục tương ứng. Dưới đó, **Cần chú ý** liệt kê việc trễ hạn và thói quen đang ở buổi quyết định (bấm vào dòng để mở); còn lại là phân bố trạng thái, biểu đồ 7 ngày của việc hoàn thành và của phút làm sâu, phân bố theo mảng và theo ưu tiên.
