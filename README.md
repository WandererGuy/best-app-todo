...
- **Trước phiên** gõ một dòng "phiên này xong thì cái gì xong?". **Trong phiên**: chợt nhớ việc khác thì gõ vào ô **Ghi để sau** rồi Enter — việc vào mục Để sau, mình quay lại việc đang làm. **⚡ Bị gián đoạn** khi người khác cắt ngang: đồng hồ dừng và ghi lại lần đó; dừng quá 2 phút thì app hỏi làm tiếp hay huỷ phiên.
...
- **Toàn màn hình** (nút **⤢**, Esc để thoát): chỉ còn đồng hồ, task, mục tiêu và vài nút. Nền đổi theo **Tập trung / Nghỉ ngắn / Nghỉ dài**, mỗi pha có màu nền, ảnh nền (giữ phần trong suốt của PNG) với độ rõ chỉnh được, và lớp phủ tối hoặc sáng để chữ luôn dễ đọc.

Đồng hồ tính theo mốc thời gian chứ không đếm nhịp, nên F5, chuyển tab hay tắt app giữa phiên đều không lệch; phiên hết giờ lúc app đang tắt được ghi nhận khi mở lại. Đồng hồ hiện cả trên tiêu đề tab. Mục Tập trung có tiến độ hôm nay, 7 ngày gần nhất, tuần, tháng, chuỗi dài nhất, và tổng kết trong ngày (phút tập trung, số task, số lần ghi để sau, số lần bị gián đoạn, điểm tập trung trung bình, danh sách phiên).
