...
- **Trong phiên**: chợt nhớ việc khác thì gõ vào ô **Ghi để sau** rồi Enter — việc vào mục Để sau, mình quay lại việc đang làm. **⏸ Tạm dừng** khi phải rời việc; dừng quá 2 phút thì app hỏi làm tiếp hay huỷ phiên.
